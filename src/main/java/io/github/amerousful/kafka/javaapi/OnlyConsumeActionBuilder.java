...
public final class OnlyConsumeActionBuilder implements ActionBuilder {
    ...
    @NonNull
    public OnlyConsumeActionBuilder groupName(@NonNull Function<Session, String> customGroup) {
        return new OnlyConsumeActionBuilder(wrapped.groupName(javaFunctionToExpression(customGroup)));
    }

    @NonNull
    public OnlyConsumeActionBuilder groupName(@NonNull String customGroup) {
        return new OnlyConsumeActionBuilder(wrapped.groupName(toStringExpression(customGroup)));
    }
