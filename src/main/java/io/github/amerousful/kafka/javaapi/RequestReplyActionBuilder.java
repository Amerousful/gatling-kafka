...
public final class RequestReplyActionBuilder implements ActionBuilder {
    ...
    @NonNull
    public RequestReplyActionBuilder groupName(@NonNull Function<Session, String> customGroup) {
        return new RequestReplyActionBuilder(wrapped.groupName(javaFunctionToExpression(customGroup)));
    }

    @NonNull
    public RequestReplyActionBuilder groupName(@NonNull String customGroup) {
        return new RequestReplyActionBuilder(wrapped.groupName(toStringExpression(customGroup)));
    }
